    ...
    converter.json2csv(
      ...
      data.map(
        ...
        X => ({
          ...
          RutEmpresa                 :X.RutEmpresa                  ?X.RutEmpresa:'',
          RutTrabajador              :X.RutTrabajador               ?X.RutTrabajador:'',
          FechaInicioContrato        :X.FechaInicioContrato         ?X.FechaInicioContrato:'',
          FechaTerminoContrato       :X.FechaTerminoContrato        ?X.FechaTerminoContrato:'',
          CausalFiniquitoId          :X.CausalFiniquitoId           ?X.CausalFiniquitoId:'',
          Funciones                  :X.Funciones                   ?X.Funciones:'',
          RegionTrabajoId            :X.RegionTrabajoId             ?X.RegionTrabajoId:'',
          LugarPresentacionTrabajo   :X.LugarPresentacionTrabajo    ?X.LugarPresentacionTrabajo:'',
          IndemnizacionFeriado       :X.IndemnizacionFeriado        ?X.IndemnizacionFeriado:'',
          remuneracionPendiente      :X.remuneracionPendiente       ?X.remuneracionPendiente:'',
          Email                      :X.Email                       ?X.Email:'',
          CodigoComunaPersonal       :X.CodigoComunaPersonal        ?X.CodigoComunaPersonal:'',
          CallePersonal              :X.CallePersonal               ?X.CallePersonal:'',
          NumeroPersonal             :X.NumeroPersonal              ?X.NumeroPersonal:'',
          DepartamentoBlockPersonal  :X.DepartamentoBlockPersonal   ?X.DepartamentoBlockPersonal:'',
          Telefono                   :X.Telefono                    ?X.Telefono:'',
          CuentaTransferencia        :X.CuentaTransferencia         ?X.CuentaTransferencia:'',
          BancoId                    :X.BancoId                     ?X.BancoId:'',
          TipoCuentaId               :X.TipoCuentaId                ?X.TipoCuentaId:'',
      ...
      res.attachment('Finiquitos.csv').send(csv)
